...
class SearchAdapter: BaseAdapter<AdapterItemSearch>(diffCallback) {
    ...
    private var onPopularPokemonItemClickListener: OnItemClickListener<PokemonMinimal>? = null

    fun setOnItemClickListener(onItemClickListener: OnItemClickListener<AdapterItemSearch>?) {
        this.onItemClickListener = onItemClickListener
    }
    fun setOnPopularPokemonItemClickListener(onItemClickListener: OnItemClickListener<PokemonMinimal>?) {
    ...
    private inner class SuggestionPopularPokemonViewHolder(
        ...
        private val onItemClickListener = OnItemClickListener<PokemonMinimal> { view, item ->
