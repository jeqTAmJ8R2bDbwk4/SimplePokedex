...
class SettingsFragment: PreferenceFragmentCompat() {
    ...
    private lateinit var preferenceVersionKey: String
    private lateinit var preferenceThemeKey: String
    private lateinit var preferenceThemeEntryValueAuto: String
    private lateinit var preferenceCacheKey: String
    private lateinit var preferenceHistoryKey: String
    private lateinit var preferenceDataSavingKey: String
    private lateinit var preferenceSystemSettingsKey: String
    private lateinit var preferenceLicensesKey: String
    ...
    @DrawableRes fun getPreferenceThemeIcon(@NightMode nightMode: Int): Int {
        return when (nightMode) {
            AppCompatDelegate.MODE_NIGHT_YES -> R.drawable.preference_icon_theme_dark_24dp
            AppCompatDelegate.MODE_NIGHT_NO -> R.drawable.preference_icon_theme_light_24p
            AppCompatDelegate.MODE_NIGHT_FOLLOW_SYSTEM -> R.drawable.preference_icon_theme_auto_24dp
            AppCompatDelegate.MODE_NIGHT_UNSPECIFIED -> {
                Timber.e("Unexpected defaultNightMode: MODE_NIGHT_UNSPECIFIED")
                assert(false)
                R.drawable.preference_icon_theme_auto_24dp
            }
            AppCompatDelegate.MODE_NIGHT_AUTO_BATTERY -> {
                Timber.e("Unexpected defaultNightMode: MODE_NIGHT_AUTO_BATTERY")
                assert(false)
                R.drawable.preference_icon_theme_auto_24dp
            }
            else -> {
                Timber.e("Unexpected defaultNightMode: $nightMode")
                assert(false)
                R.drawable.preference_icon_theme_auto_24dp
            }
        }
